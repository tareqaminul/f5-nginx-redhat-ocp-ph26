...
```
kubectl apply -f appolicy-coffee.yaml
kubectl apply -f appolicy-tea.yaml
kubectl apply -f appolicy-cocoa.yaml
```
...
```
curl "http://nap-cafe.f5k8s.net:30000/tea/?user=<script>"
...
Send a malicious request to the path /tea:
```
curl "http://nap-cafe.f5k8s.net:30000/coffee/?user=<script>"
