...
```
cd ~/f5-nginx-redhat-ocp-ph26/Part-1-Nginx-Ingress-Controller/7.tls
```
...
```
oc apply -f virtual-server.yaml
```
...
To get coffee:
```
curl -k https://tls.f5k8s.net:30400/coffee
...
If your prefer tea:
```
curl -k https://tls.f5k8s.net:30400/tea
...
```
oc delete -f cafe-virtual-server.yaml
```    
