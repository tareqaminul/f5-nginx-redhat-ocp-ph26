...
```
cd ~/f5-nginx-redhat-ocp-ph26/Part-1-Nginx-Ingress-Controller/4.cross-namespace-configuration
```
...
```
oc describe virtualserverroute tea -n tea
oc describe virtualserverroute coffee -n coffee 
...
To get coffee:
```
curl https://cafe.example.com:30400/coffee --insecure
...
If your prefer tea:
```
curl https://cafe.example.com:30400/tea --insecure
