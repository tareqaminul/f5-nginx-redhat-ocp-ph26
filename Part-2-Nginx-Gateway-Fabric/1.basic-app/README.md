...
```code
cd ~/f5-nginx-redhat-ocp-ph26/Part-2-Nginx-Gateway-Fabric/1.basic-app
```
...
```
Please Ignore if you have services additional to these, such as, service/openshift, service/kubernetes etc.
